...
class Products extends StatelessWidget {  //the actual change of data occurs in MyApp's products property
      //so this widget need not be stateful .It's just called in MyApp

  final List<String> products;  //final keyword suggests that products property will never change once initialized (here by the constructor). Code works without it tough.
  ...
  Products(this.products){   //constructor of Product class which will receive data in products property of 'this' class
 ...
 Widget _buildItemsList(BuildContext context,int index){
  ...
  Widget _buildProductList(){
    ...
    productView = Center(child: Text("No product found please enter a product"),widthFactor: 6.0,);
